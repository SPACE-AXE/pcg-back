...
export class Migration1715511010702 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`parking_transaction\` CHANGE \`car_id\` \`car_num\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`parking_transaction\` CHANGE \`car_num\` \`car_id\` int NULL`);
