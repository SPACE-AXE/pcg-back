...
export class Migration1715514865422 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`car\` CHANGE \`user_id\` \`userId\` int NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`email_token\` DROP COLUMN \`user_id\``,
    );
    await queryRunner.query(`ALTER TABLE \`card\` DROP COLUMN \`user_id\``);
    await queryRunner.query(
      `ALTER TABLE \`parking_transaction\` DROP COLUMN \`user_id\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`parking_transaction\` DROP COLUMN \`park_id\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`parking_transaction\` DROP COLUMN \`car_id\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`parking_transaction\` ADD \`userId\` int NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`parking_transaction\` ADD \`parkId\` int NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`parking_transaction\` ADD \`carId\` int NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`parking_transaction\` ADD CONSTRAINT \`FK_6a454dcd8f1a3b30b6b134c5256\` FOREIGN KEY (\`userId\`) REFERENCES \`user\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE \`parking_transaction\` ADD CONSTRAINT \`FK_2eb7f73d0b351e7c0f40f4ae8a5\` FOREIGN KEY (\`parkId\`) REFERENCES \`park\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE \`parking_transaction\` ADD CONSTRAINT \`FK_54bc2e36a3aaba62959da73093b\` FOREIGN KEY (\`carId\`) REFERENCES \`car\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`parking_transaction\` DROP FOREIGN KEY \`FK_54bc2e36a3aaba62959da73093b\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`parking_transaction\` DROP FOREIGN KEY \`FK_2eb7f73d0b351e7c0f40f4ae8a5\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`parking_transaction\` DROP FOREIGN KEY \`FK_6a454dcd8f1a3b30b6b134c5256\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`car\` DROP FOREIGN KEY \`FK_a4f3cb1b950608959ba75e8df36\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`parking_transaction\` DROP COLUMN \`carId\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`parking_transaction\` DROP COLUMN \`parkId\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`parking_transaction\` DROP COLUMN \`userId\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`parking_transaction\` ADD \`car_id\` int NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`parking_transaction\` ADD \`park_id\` int NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`parking_transaction\` ADD \`user_id\` int NULL`,
    );
    await queryRunner.query(`ALTER TABLE \`card\` ADD \`user_id\` int NULL`);
    await queryRunner.query(
      `ALTER TABLE \`email_token\` ADD \`user_id\` int NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`car\` CHANGE \`userId\` \`user_id\` int NULL`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_00ec72ad98922117bad8a86f98\` ON \`card\` (\`user_id\`)`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX \`REL_c728d9445f15cd00fb479ad92d\` ON \`email_token\` (\`user_id\`)`,
    );
    await queryRunner.query(
